...
def run_two_bit_test():
    ...
    check_result(two_bit_test_result, 3.841, "two-bit test", two_bit_result_label)
...
root = tk.Tk()
root.title("ECDH Message Encryption")
root.geometry("1550x520")
root.resizable(False, False)
lokalny_klucz_prywatny_label = tk.Label(root, text="Local Private Key:")
...
local_public_key_label = tk.Label(root, text="Local Public Key:")
...
second_private_key_label = tk.Label(root, text="Remote Private Key:")
...
second_public_key_label = tk.Label(root, text="Remote Public Key:")
...
generate_keys_przycisk = tk.Button(root, text="Generate Keys", command=generate_keys)
...
zaszyfruj_przycisk = tk.Button(root, text="Encrypt Message", command=encrypt_message)
...
deszyfruj_przycisk = tk.Button(root, text="Decrypt Message", command=decrypt_message)
deszyfruj_przycisk.place(x=480, y=300)
encrypt_message_label = tk.Label(root, text="Decrypted Message:")
...
back_button = tk.Button(root, text="Back", command=back, width=20, height=2)
