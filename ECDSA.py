...
def public_key():
    ...
    try:
        ...
        entry_field2.delete(0, "end")
        entry_field2.insert(0, "Błąd: Nieprawidłowy klucz prywatny")
...
def check():
    ...
    try:
        ...
        try:
            ...
            entry_field5.insert(0, "Podpis jest prawidłowy.")
            entry_field5.config(state='disabled')
        except BadSignatureError:
            entry_field5.delete(0, "end")
            entry_field5.insert(0, "Podpis jest nieprawidłowy.")
            entry_field5.config(state='disabled')
    except (ValueError, ecdsa.keys.MalformedPointError):
        entry_field5.config(state='normal')
        entry_field5.delete(0, "end")
        entry_field5.insert(0, "Błąd: Nieprawidłowy klucz publiczny")
...
def run_two_bit_test():
    ...
    check_result(two_bit_test_result, 5.991, "testu dwubitowego", two_bit_result_label)
...
back_button = tk.Button(root, text="Powrót", command=back, width=10, height=2)
